...
export const SovereignTopology = forwardRef<TopologyRef, Props>(({ xml, onNodeClick, containerClassName }, ref) => {
  ...
  return <div ref={containerRef} className={`topology-container ${containerClassName ?? ''}`.trim()} />;
});
