...
describe("useSearchBarInteractions", () => {
  ...
  it("composes child hooks and returns merged interaction api", () => {
    ...
    expect(useSearchKeyboardNavigationMock).toHaveBeenCalledWith({
      ...
      activeSuggestionIndex: params.state.activeSuggestionIndex,
      resultCount: params.state.resultCount,
      resultSelectedIndex: params.state.resultSelectedIndex,
      ...
      setQuery: params.actions.setQuery,
      setShowSuggestions: params.actions.setShowSuggestions,
      setResultSelectedIndex: params.actions.setResultSelectedIndex,
      setActiveSuggestionIndex: params.actions.setActiveSuggestionIndex,
      selectSuggestion: params.actions.selectSuggestion,
    });
