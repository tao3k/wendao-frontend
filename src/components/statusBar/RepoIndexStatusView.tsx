  ...
  return (
    ...
    >
      ...
      <span className="status-popover" role="tooltip">
        ...
        {concurrencyLabel && <span className="status-popover__line">{concurrencyLabel}</span>}
        {exclusionLabel && <span className="status-popover__line">{exclusionLabel}</span>}
        {unsupportedLabel && <span className="status-popover__line">{unsupportedLabel}</span>}
        ...
        {issueLabel && (
          <span className="status-popover__line status-popover__line--warning">{issueLabel}</span>
        )}
      </span>
    </button>
  );
