...
function makeResult(
  ...
  return {
    ...
    navigationTarget: navigationTarget ?? {
      path,
      category: "doc",
      ...(overrides.projectName ? { projectName: overrides.projectName } : {}),
      ...(overrides.rootLabel ? { rootLabel: overrides.rootLabel } : {}),
      ...(typeof overrides.line === "number" ? { line: overrides.line } : {}),
      ...(typeof overrides.lineEnd === "number" ? { lineEnd: overrides.lineEnd } : {}),
      ...(typeof overrides.column === "number" ? { column: overrides.column } : {}),
    },
