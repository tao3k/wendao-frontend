...
const autocompleteState = vi.hoisted(() => ({
  onStateChange: null as ((payload: { state: { collections: Array<{ items: Array<{ text: string; suggestionType: string; docType?: string }> }>; activeItemId?: number | null; isOpen: boolean } }) => void) | null,
  api: {
...
vi.mock('@algolia/autocomplete-core', () => ({
  createAutocomplete: vi.fn((options: { onStateChange: typeof autocompleteState.onStateChange }) => {
