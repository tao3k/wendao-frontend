...
describe('PropertyField', () => {
  it('should render label and input', () => {
    render(
      <PropertyField label="Name" value="Test Value" />
    );
  ...
  it('should render text input by default', () => {
    render(
      <PropertyField label="Name" value="Test" />
    );
  ...
  it('should render number input when type is number', () => {
    render(
      <PropertyField label="X" value={100} type="number" />
    );
  ...
  it('should call onChange when value changes', () => {
    ...
    render(
      <PropertyField label="Name" value="Test" onChange={onChange} />
    );
  ...
  it('should disable input when disabled prop is true', () => {
    render(
      <PropertyField label="ID" value="node-123" disabled />
    );
  ...
  it('should show placeholder when provided', () => {
    render(
      <PropertyField label="Name" value="" placeholder="Enter name..." />
    );
  ...
  it('should not update value when disabled', () => {
    const onChange = vi.fn();
    render(
      <PropertyField label="ID" value="123" disabled onChange={onChange} />
    );
