...
describe("MainViewReferencesPanel", () => {
  it("shows empty guidance when no file is selected", () => {
    ...
    render(<MainViewReferencesPanel selectedFile={null} relationships={[]} copy={copy} />);
    ...
    expect(
      screen.getByText("Select a file from the project tree to inspect its references."),
    ).toBeInTheDocument();
  });
