...
describe('useSearchBarControllerPresentation', () => {
  ...
  it('keeps results-panel props stable when only suggestion highlight changes', () => {
    const trace = createPerfTrace('SearchBarControllerPresentation.suggestion-hover-results-stable');
    ...
    const baseProps = {
      ...
      repoSlice: {
        parsedCodeInput: {
          baseQuery: 'sec',
          filters: { repo: [], kind: [], lang: ['julia'], path: [], symbol: [], section: [], tag: [] },
        },
        parsedCodeSearch: {
          baseQuery: 'sec',
          filters: { repo: [], kind: [], lang: ['julia'], path: [], symbol: [], section: [], tag: [] },
        ...
        activeCodeFilterEntries: [
          { kind: 'lang', rawToken: 'lang:julia', value: 'julia' },
        ],
        suggestions: [
