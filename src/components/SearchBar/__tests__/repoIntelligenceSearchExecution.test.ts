...
describe('repoIntelligenceSearchExecution', () => {
  ...
  it('routes explicit module facets through repo-search Flight tag filters', async () => {
    ...
    const outcome = await executeRepoIntelligenceCodeSearch('kind:module GatewaySyncPkg', 'gateway-sync', {
      facet: 'module',
    });
  ...
  it('routes explicit example facets through repo-search Flight tag filters', async () => {
    ...
    const outcome = await executeRepoIntelligenceCodeSearch('kind:example solve_demo', 'gateway-sync', {
      facet: 'example',
    });
